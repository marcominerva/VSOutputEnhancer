...
public class BuildResultData : ParsedData
{
    ...
    public BuildResultData(ParsedValue<int> succeeded, ParsedValue<int> failed, ParsedValue<int> upToDate, ParsedValue<int> skipped)
    {
        Succeeded = succeeded;
        Failed = failed;
        UpToDate = upToDate;
    ...
    public ParsedValue<int> Succeeded { get; private set; } = new();

    public ParsedValue<int> Failed { get; private set; } = new();

    public ParsedValue<int> UpToDate { get; private set; } = new();

    public ParsedValue<int> Skipped { get; private set; } = new();
