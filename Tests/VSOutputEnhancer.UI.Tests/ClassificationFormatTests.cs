...
using Balakin.VSOutputEnhancer.UI.FormatDefinitions;
...
namespace Balakin.VSOutputEnhancer.UI.Tests
{
    ...
    public class ClassificationFormatTests
    {
        ...
        {
            { typeof(BuildProjectHeaderFormatDefinition), "Output enhancer: Build project header" },
        ...
        {
            var styleManager = Substitute.For<IStyleManager>();
